...
metadata:
  title: Hakkımızda
  description: Hukuk büromuzun mükemmeliyet, dürüstlük ve müvekkil odaklı hizmet taahhüdünü keşfedin. Deneyimli avukatlarımızı ve çeşitli çalışma alanlarımızı tanıyın.
hero:
  tagline: Hakkımızda
...
practiceAreas:
  ...
  - title: Dış Genel Hukuk Müşavirliği ve Danışmanlık
    description: Girişimlere ve büyüyen işletmelere sözleşmeler, uyum, risk yönetimi ve operasyonlarda sürekli hukuki danışmanlık sunar.
    icon: tabler:medical-cross
  - title: Gayrimenkul Hukuku
    description: Ticari ve konut işlemlerinde destek vererek her taşınmaz işleminin güvenli ve sorunsuz ilerlemesini sağlar.
    icon: tabler:home
...
values:
  title: Yaklaşımımız
  subtitle: Capitol Law Partners olarak, duyarlı, kişiselleştirilmiş ve güvene dayalı bir hukuk deneyimi sunmaktan gurur duyuyoruz. Her müvekkil, konu ne kadar karmaşık olursa olsun desteklenmiş ve güçlenmiş hisseder.
  items:
  - title: Müvekkil Odaklı Çözümler
    description: Hedefleriniz stratejimizi şekillendirir. Sizi dikkatle dinler, her planı özel durumunuza göre uyarlar ve en çok önem verdiğiniz şeylerle uyumlu pratik sonuçlar sunmaya odaklanırız.
  - title: Açık ve Erişilebilir İletişim
    description: Sizin dilinizden konuşuruz. Avukatlarımız, hukuki jargonun ötesine geçerek karmaşık konuları sade ve anlaşılır bir şekilde açıklar—her adımda sizi bilgilendirir ve güven verir.
  - title: Dürüstlük ve Kişisel Bağ
    description: Her dosyanın arkasında bir insan, bir işletme veya bir aile vardır. Dürüstlük, saygı ve hukuki meselenizi özen ve aciliyetle ele alma taahhüdüyle kalıcı ilişkiler kurarız.
locations:
...
contact:
  ...
  - title: Bizi arayın
    description: Uzman avukatlarımızla doğrudan görüşerek hukuki danışmanlık ve destek alın. +1 (202) 440-2272
