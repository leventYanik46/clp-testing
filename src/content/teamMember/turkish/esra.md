...
metadata:
  ...
  description: Esra Nur Bulan’ın göçmenlik hukuku, insani yardım ve aile temelli başvurulara olan bağlılığını keşfedin. Türkçe ve İngilizce bilen iki dilli bir savunucu.
profile:
  id: about
  columns: 2
  name: Esra Nur Bulan
...
- id: resume
  ...
  - title: Penn State University <br /><span class="text-sm font-normal">(2017) – J.D.</span>
    icon: tabler:school
  - title: İstanbul Üniversitesi Hukuk Fakültesi <br /><span class="text-sm font-normal">(2016) – LL.B.</span>
    icon: tabler:school
  classes:
    container: max-w-3xl
- id: resume
