...
metadata:
  ...
  description: Conozca la dedicación de Esra Nur Bulan al derecho migratorio, el alivio humanitario y las peticiones basadas en la familia. Defensora bilingüe fluida en turco e inglés.
profile:
  id: about
  columns: 2
  name: Esra Nur Bulan
...
- id: resume
  ...
  - title: Penn State University <br /><span class="text-sm font-normal">(2017) – J.D.</span>
    icon: tabler:school
  - title: Facultad de Derecho de la Universidad de Estambul <br /><span class="text-sm font-normal">(2016) – LL.B.</span>
    icon: tabler:school
  classes:
    container: max-w-3xl
- id: resume
