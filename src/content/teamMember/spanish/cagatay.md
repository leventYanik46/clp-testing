...
metadata:
  title: Cagatay Ersoy
  description: Cagatay Ersoy, socio de Capitol Law Partners y graduado de Columbia Law, ofrece estrategias legales enfocadas en resultados respaldadas por experiencia internacional en litigios.
profile:
  id: about
  columns: 2
  image:
  ...
  - Además de su trabajo corporativo y migratorio, el Sr. Ersoy ayuda a los dueños de marcas a proteger su propiedad intelectual mediante servicios integrales de marcas registradas. Asesora en búsquedas, registro y estrategias de cumplimiento, ayudando a asegurar y construir valor de marca a largo plazo en el mercado estadounidense.
  - Antes de fundar Capitol Law Partners, el Sr. Ersoy se desempeñó como abogado de litigios en Türkiye. Representó a clientes de industrias como tecnología, logística, construcción y retail en Asia Central y Medio Oriente. Su labor abarcó cumplimiento normativo, derecho laboral y administrativo, litigios complejos y apelaciones internacionales, incluidos asuntos ante el Tribunal Europeo de Derechos Humanos y el Tribunal Constitucional de Türkiye.
...
- id: resume
  ...
  - title: Columbia Law School <br /><span class="text-sm font-normal">(2022)</span>
    icon: tabler:school
  - title: Facultad de Derecho de la Universidad de Estambul <br /><span class="text-sm font-normal">(2015)</span>
    icon: tabler:school
  classes:
    container: max-w-3xl
- id: resume
...
testimonials:
  ...
  - title: '"¡Lo recomiendo ampliamente!"'
    testimonial: Trabajé con el abogado Cagatay para mi solicitud de Green Card y quedé muy satisfecho. Tiene un gran conocimiento y gestionó el proceso de manera profesional. Respondió mis preguntas con rapidez y me ayudó en cada etapa. ¡Lo recomiendo a cualquiera que busque un abogado confiable!
    name: Harun Demir
    image:
